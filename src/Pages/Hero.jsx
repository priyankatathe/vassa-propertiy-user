      ...
      <div className="relative z-10 w-full h-full px-5 sm:px-10 md:px-20 lg:px-25 flex flex-col justify-center md:justify-start items-center md:items-start text-center md:text-left">
        ...
        <div className="mt-10 sm:mt-10 md:mt-52 space-y-2 w-full md:w-[90%]">
          <h1 className="text-4xl sm:text-6xl md:text-7xl font-bold text-white leading-snug">
            Find Your Perfect{" "}
            <span className="text-[#F8CA13] text-4xl sm:text-5xl md:text-7xl font-playfair">
              Home
            </span>{" "}
            with
          </h1>
        ...
        <div className="block md:hidden mt-7 flex flex-col items-center text-center px-4">

          <p className="text-gray-200 text-base leading-relaxed mb-4">
            Discover premium homes, apartments, and plots across the finest
            locations — all verified and handpicked for your lifestyle and
            budget.
          </p>
          ...
          <div className="flex items-center mt-3 justify-center gap-3">
            <Link
              to="/find-home"
              className="px-8 py-3 bg-[#F8CA13] text-white font-semibold text-lg rounded-full transition-all duration-300"
            >
              Get Started
            </Link>
            ...
            <Link
              to="/find-home"
              className="border border-white rounded-full h-14 w-14 flex items-center justify-center text-2xl"
            >
        ...
        <div className="hidden md:flex relative items-center justify-center px-2  py-5">
          <Link
            to="/find-home"
            className="mt-4 px-8 py-3 bg-[#F8CA13] text-white font-semibold text-lg rounded-full transition-all duration-300"
          >
            Get Started
          </Link>
